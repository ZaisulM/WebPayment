...
<?php 
 			include"../../config/koneksi.php";
 			$bulan = $_POST['bulan'];
 			$query = mysql_query("SELECT * FROM tagihan a, pelanggan b WHERE a.id_pelanggan = b.id_pelanggan AND bulanTagih = '$bulan'")or die(mysql_errror());
...
<a href="tagihan.php" class="button">KEMBALI</a><br>
<br>
